    ...
    public partial class MainForm : Form
    {
        ...
        void MainForm_Load(object sender, EventArgs e)
        {
            ...
            if (File.Exists(".laststate.rmproj"))
            {
                try
                {
                    loader.Log("Load Last State");
                    LoadProject(".lastState.rmproj");
                }
                catch
                {
                    File.Move(".laststate.rmproj", "err" + DateTime.Now.ToFileTimeUtc() + ".laststate.rmproj");
                    MessageBox.Show("An error occurred loading the last state of RAF Manager.  The last state will not be loaded");
                    ResetProject();
                }
            }
        ...
        private void MainForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            //Also save recent regardless, we'll load this the next time we start up
